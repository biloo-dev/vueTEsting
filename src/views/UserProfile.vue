  ...
  <v-row justify="center">
        ...
        <v-form>
          <v-container class="py-0">
            <v-row>
              ...
              <v-col cols="12" md="4">
                <v-text-field color="purple" label="Postal Code" type="number" />
              </v-col>

              <v-col cols="12">
                <v-textarea color="purple" label="About Me" value="Lorem ipsum dolor sit amet, consectetur adipiscing elit." />
              </v-col>
    ...
    <v-col cols="12" md="4">
      <app-card class="mt-4 text-center">
        <v-img class="rounded-circle elevation-6 mt-n12 d-inline-block" src="https://demos.creative-tim.com/vue-material-dashboard/img/marc.aba54d65.jpg" width="128" />

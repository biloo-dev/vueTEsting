<style>
  ...
  /* ----------------------------------------------
 * Generated by Animista on 2021-2-4 16:9:52
...
<div id="settings-wrapper">
  <v-card id="settings" class="py-2 px-4 " color="rgba(0, 0, 0, .3)" dark flat link min-width="100" style="position: fixed; top: 115px; right: -35px; border-radius: 8px; z-index: 1;">
    <v-icon large class="rotate-center">
      mdi-cog
    </v-icon>
  </v-card>
    ...
    <v-card class="text-center mb-0" width="300">
      <v-card-text>
        ...
        <v-row align="center" no-gutters>
          ...
          <v-col cols="auto">
            <v-switch v-model="mini" class="ma-0 pa-0" color="secondary" hide-details />
          </v-col>
        </v-row>
        ...
        <v-row align="center" no-gutters>
          ...
          <v-col cols="auto">
            <v-switch v-model="drawerImage" class="ma-0 pa-0" color="secondary" hide-details />
          </v-col>
        </v-row>
